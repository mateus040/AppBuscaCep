...
namespace AppBuscaCep.Service
{
    public class DataService
    {
        ...
        public static async Task<List<Cidade>> GetCidadeByUF(int id_uf)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                HttpResponseMessage response = await client.GetAsync("https://cep.metoda.com.br/cidade/by-uf?uf=" + id_uf);
